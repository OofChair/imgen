...
from endpoints.tools import getavatar, getarg, gen_file_response
...
async def balloon(request):
    ...
    balloon_text_2_font, balloon_text_2 = auto_text_size(
        balloon, font, 170, font_scalar=0.95
    )
    balloon_text_3_font, balloon_text_3 = auto_text_size(
        balloon, font, 110, font_scalar=0.8
    )
    label_font, label_text = auto_text_size(label, font, 125)

    render_text_with_emoji(
        base, canv, (80, 180), balloon_text_1, font=balloon_text_1_font, fill="Black"
    )
    render_text_with_emoji(
        base, canv, (50, 530), balloon_text_2, font=balloon_text_2_font, fill="Black"
    )
    render_text_with_emoji(
        base, canv, (500, 520), balloon_text_3, font=balloon_text_3_font, fill="Black"
    )
    render_text_with_emoji(
        base, canv, (620, 155), label_text, font=label_font, fill="Black"
    )
    base = base.convert("RGB")
    return gen_file_response(base, {"format": "png"})
...
async def byemom(request):
    ...
    render_text_with_emoji(
        bye_layer, bye, (0, 0), msg, font=bye_font, fill=(42, 40, 165)
    )
...
async def cheating(request):
    ...
    render_text_with_emoji(
        base, canv, (155, 200), classmate[:50], font=font, fill="White"
    )
...
async def corporate(request):
    ...
    img2 = skew(
        img2, [(858, 112), (1600, 206), (1312, 666), (634, 546)], resolution=1400
    )
